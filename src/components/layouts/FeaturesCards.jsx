  ...
  return (
    <div className=' h-[80vh] md:h-[90vh] md:pl-[5vw] md:pr-[5vw]'>
        ...
        <div className='  h-[70vh] p-[8px] flex flex-col justify-start items-center md:pl-[15px] md:flex-row md:h-[50vh]'>
            {/* description  */}
            <div className=' h-[32vh] p-[8px] flex flex-col justify-start items-start gap-2 bg-[#EEEEEE] rounded-xl md:w-[44vw] md:h-[42vh]'>
            ...
            {/* image */}
            <div className='  h-[30vh] flex justify-center items-center p-[5px] md:w-[50vw] md:h-[42vh]'>
